...
const highlights = [
  ...
  },
  {
    ...
    description:
      "Automated key/card issuance, return tracking, and audit trails to reduce unauthorized handling and improve compliance.",
  },
];
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {highlights.map((item) => (
            <article key={item.title} className="card-shell p-6">
              <h3 className="font-rajdhani text-2xl font-bold uppercase text-slate-900">
                {item.title}
              </h3>
